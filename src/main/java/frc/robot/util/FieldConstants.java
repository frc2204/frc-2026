...
public class FieldConstants {
    ...
    public static final Pose2d HUBPOSE = new Pose2d(ALLIANCEWALLTOHUB, FIELDWIDTH / 2.0, new Rotation2d()); //middle of hub

    public static final Pose2d DEPOTPOSE = new Pose2d(0.3429, 5.963158, new Rotation2d()); //middle of depot

    public static final double TRENCHWIDTH = 1.284986;

    public static final Pose2d TOPLEFTSIDETRENCH = new Pose2d(ALLIANCEWALLTOHUB, FIELDWIDTH, new Rotation2d());
    public static final Pose2d TOPRIGHTSIDETRENCH = new Pose2d(ALLIANCEWALLTOHUB, FIELDWIDTH-TRENCHWIDTH, new Rotation2d());

    public static final Pose2d BOTTOMLEFTSIDETRENCH = new Pose2d(ALLIANCEWALLTOHUB, TRENCHWIDTH, new Rotation2d());
    public static final Pose2d BOTTOMRIGHTSIDETRENCH = new Pose2d(ALLIANCEWALLTOHUB, 0.0, new Rotation2d());
