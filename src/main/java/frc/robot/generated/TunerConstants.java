...
//
//  private static final boolean kInvertFrontRightSide = true;
//  private static final boolean kInvertBackLeftSide = false;
//  private static final boolean kInvertBackRightSide = true;
//  private static final boolean kInvertFrontLeftSide = false;
//
...
//  // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
//  private static final Slot0Configs driveGains =
//      new Slot0Configs().withKP(2).withKI(0).withKD(0.02).withKS(0).withKV(0.124);
//
//  // The closed-loop output type to use for the steer motors;
//  // This affects the PID/FF gains for the steer motors
//  private static final ClosedLoopOutputType kSteerClosedLoopOutput = ClosedLoopOutputType.Voltage;
...
//  private static final double kSteerGearRatio = 12.1;
//  private static final Distance kWheelRadius = Inches.of(2.175);
//
...
//  private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.448486328125);
...
//  private static final Angle kBackLeftEncoderOffset = Rotations.of(0.06103515625);
...
public class TunerConstants {
  ...
  // output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(10).withKI(0).withKD(0).withKS(1.5).withKV(0).withKA(0);
  ...
  // Theoretical free speed (m/s) at 12 V applied output;
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.41); // 4.98?
